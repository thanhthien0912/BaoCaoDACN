...
% \usepackage{subfigure} % Xung đột với subcaption - đã xóa
\usepackage[vietnamese]{babel}
\usepackage{indentfirst}
\usepackage{color}
% \usepackage[utf8]{inputenc} % Không cần với XeLaTeX - đã xóa
% \usepackage{emoji} % Chỉ hoạt động với LuaTeX - đã xóa
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts}
\usepackage{graphics}
...
\usepackage{mdframed}
% \usepackage{xeCJK} % Chỉ hoạt động với XeLaTeX, không cần cho document này
\usepackage{array}
\usepackage{arydshln}
\usepackage{pgfgantt}
...
% \usepackage{adjustbox} % Duplicate - sẽ load lại với [export] option ở dưới
...
% Can le van ban
% \usepackage[left=3cm,right=2cm,top=2cm,bottom=2cm]{geometry} % Duplicate - đã load ở đầu file
%\usepackage{fancyhdr}
