...
\begin{itemize}
    \item \textbf{Tiện lợi hóa thanh toán}: Thay thế tiền mặt và thẻ vật lý bằng thanh toán NFC một chạm hoặc QR Code ngay trên điện thoại.
...
\begin{itemize}
    ...
    \item \textbf{Thẻ ATM/Thẻ sinh viên}: Cần mang theo thẻ vật lý, quy trình thanh toán qua POS đôi khi chậm.
